...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {(!urls || urls.length == 0) && (
                  <tr>
                    <td
                      colSpan="3"
                      className="px-2 py-4 whitespace-nowrap cursor-pointer"
                    >
                      No record found
                    </td>
                  </tr>
      ...
      <Link href="/addUrl">
        <button className="absolute rounded-full text-white font-bold text-lg p-2 bg-blue-800 w-12 h-12 m-4 right-0 bottom-0 hover:bg-blue-400">
          {' '}
          +{' '}
        </button>
      </Link>
